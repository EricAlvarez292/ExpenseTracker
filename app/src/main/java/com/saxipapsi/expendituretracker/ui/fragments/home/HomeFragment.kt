...
class HomeFragment : Fragment() {
    ...
    private fun setAdapter(view : View) {
      MainActivity.getInstance().expenditureTrackerViewModel = ViewModelProvider(this).get(ExpenditureTrackerViewModel::class.java)
        ...
        MainActivity.getInstance().expenditureTrackerViewModel.allBudgetedExpenses.observe(viewLifecycleOwner,
                ...
                _budgetedExpenses?.let { _budgetedExpenseList ->
                    ...
                    MainActivity.getInstance(). createBudgetPlan?.let {
                        if (it.isAdded) {
                            ...
                            MainActivity.getInstance().createBudgetPlan?.updateAdapter(budgetedExpenses)
                        }
                    }
                }
            })
